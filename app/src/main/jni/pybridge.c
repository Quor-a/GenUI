...
Java_com_genui_app_agent_python_PyEngine_nativeInit(JNIEnv *env, jobject thiz, jstring jhome) {
    (void) thiz;
...
Java_com_genui_app_agent_python_PyEngine_nativeRun(JNIEnv *env, jobject thiz, jstring jcode, jobjectArray out) {
    (void) thiz;
...
Java_com_genui_app_agent_python_PyEngine_nativeInterrupt(JNIEnv *env, jobject thiz) {
    (void) env; (void) thiz;
