package com.genui.app.websearch.net

import com.genui.app.websearch.html.MiniHtml
import com.genui.app.websearch.html.MiniHtml.textOf
...
class BingEngine(
    ...
    /** 在 a 的子树中找第一个 h2/h3 */
    private fun findHeading(n: com.genui.app.websearch.html.HNode)
        : com.genui.app.websearch.html.HNode? {
    ...
    private fun findSnippet(a: com.genui.app.websearch.html.HNode): String {
        var p = a.parent
        repeat(3) {
            if (p == null) return ""
    ...
    private fun collectCaption(n: com.genui.app.websearch.html.HNode): String {
